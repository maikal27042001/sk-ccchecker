        ...
        linhaenviar.forEach(function(value, index) {
            setTimeout(
                function() {
                  ...
                  var sec = $("#sec").val();
                            $.ajax({
                        url: 'skapi.php?lista=' + value + '&sec=' + sec + '&proxy=' + proxy,
                        async: true,
...
<div class="card col-sm-12">
  <span class="badge badge-info"><h4>SK-GATE</h4></span>
  <div class="card-body">
<div class="md-form">
  <p style="color:red; size:30px; font-weight: bold;">GATE SK [MAX 100 CHECKS] [USE PROXY ELSE FACE ERRORS]</p>
	<div class="col-md-12">
...
<span class="badge badge-white"<label for="lista">Cards in here.</label></span>
<br>
<textarea type="text" style="text-align: center;" id="lista" maxlength="2800"  class="md-textarea form-control" rows="50" placeholder="FORMAT: xxxxxxxxxxxxxxxx|mm|year|cvv" ></textarea>
<br>
...
<span class="badge badge-info"><label for="proxy">Proxies [required, else your SK will die]</label></span>
<br>
<textarea class="md-textarea form-control" style="text-align: center;" rows="5" id="proxy" placeholder="Proxy:Port"></textarea>
 </center>
&nbsp;<br>
