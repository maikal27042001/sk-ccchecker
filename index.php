                ...
                function() {
                  Array.prototype.randomElement = function () {
                   ...
                   var proxy = MyArray.randomElement();
                           $.ajax({
                        url: 'g1api.php?lista=' + value + '&proxy=' + proxy,
                        async: true,
...
<div class="card col-sm-12">
  <span class="badge badge-info"><h4>Gate 1 - CCN</h4></span>
  <div class="card-body">
<div class="md-form">
 <p style="color:yellow; size:30px; font-weight: bold;">CCN ONLY [50 CHECKS MAX]</p>
	<div class="col-md-12">
...
<span class="badge badge-white"<label for="lista">CC</label></span>
<br>
<textarea type="text" style="text-align: center;" id="lista" maxlength="1400" class="md-textarea form-control" rows="50" placeholder="FORMAT: xxxxxxxxxxxxxxxx|xx|xxxx|xxx" ></textarea>
<br>
<span class="badge badge-danger"><label for="proxy">Proxies Here.</label></span>
<br>
<textarea class="md-textarea form-control" style="text-align: center;" rows="7" id="proxy" placeholder="xxx.xx.xxx:xxxx"></textarea>
 </center>
&nbsp;<br>
